...
const DEFAULT_TERMS =
    'Prices are valid for 14 days from the date of quotation.\n50% deposit required upon acceptance to begin work.\nThis is not an invoice.';
...
export default function QuotationCreatePage({
    ...
    const [expiryAt, setExpiryAt] = useState(defaultExpiryAt);
    ...
    const totals = useMemo(() => {
        ...
        const total = subtotal - subtotal * (discountModifier / 100);
    ...
    return (
        <>
            ...
            <div className="mb-[20px] flex shrink-0 flex-wrap items-center justify-between gap-[16px]">
                <h1 className="font-mono text-[24px] font-bold [letter-spacing:-0.02em]">New Quotation</h1>
            </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-[40px] text-bion-text">
                        ...
                        <div className="mt-[32px] border-t border-bion-border pt-[24px]">
                            ...
                            <textarea
                                ...
                                rows={5}
                                placeholder="Enter terms and conditions, validity period, or special notes here..."
                                value={terms}
...
QuotationCreatePage.layout = (props: { currentTeam?: { slug: string } | null }) => ({
    breadcrumbs: [
        {
            title: 'Dashboard',
        ...
        {
            title: 'New Quotation',
            href: props.currentTeam ? quotationCreate(props.currentTeam.slug) : '/',
        },
    ],
    mainClassName:
