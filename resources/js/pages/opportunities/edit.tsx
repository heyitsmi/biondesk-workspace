...
import {
    destroy as destroyOpportunity,
    edit as opportunityEdit,
    index as opportunities,
    update as updateOpportunity,
...
const BTN_DANGER = cn(
    BTN,
    'border-none bg-transparent text-bion-danger hover:bg-bion-danger-soft',
);
                ...
                <div className="w-full max-w-[680px] pb-[80px]">
                    <div className="mb-[24px]">
                        ...
                        <p className="text-[14px] text-bion-text-muted">
                            Update details for this potential deal.
                        </p>
                    </div>
