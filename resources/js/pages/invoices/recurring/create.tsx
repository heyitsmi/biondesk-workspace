...
import type { RecurringInvoiceCreatePageProps } from '@/types';
...
export default function RecurringInvoiceCreatePage({
    defaultStartsAt,
    clients,
    projects,
}: RecurringInvoiceCreatePageProps) {
    ...
    const submit = (): void => {
        ...
        router.post(storeRecurring(currentTeam.slug).url, {
            title,
            clientId,
            projectId,
            intervalMonths,
...
RecurringInvoiceCreatePage.layout = (props: {
    ...
    breadcrumbs: [
        ...
        },
        {
            ...
            href: props.currentTeam
                ? recurringCreate(props.currentTeam.slug)
                : '/',
        },
    ],
    mainClassName:
