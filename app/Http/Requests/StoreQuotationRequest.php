...
class StoreQuotationRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'issued_at' => $this->input('issued_at', $this->input('issuedAt')) ?: null,
            'valid_until' => $this->input('valid_until', $this->input('expiryAt')) ?: null,
            'notes' => $this->input('notes', $this->input('terms')),
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'status' => ['required', Rule::in([DocumentStatus::Draft->value, DocumentStatus::Sent->value])],
