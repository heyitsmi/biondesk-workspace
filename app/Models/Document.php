 ...
 * @property int|null $recurring_invoice_template_id
 ...
 */
#[Fillable(['type', 'contact_id', 'opportunity_id', 'project_id', 'recurring_invoice_template_id', 'number', 'title', 'status', 'issued_at', 'valid_until', 'due_at', 'currency', 'discount_percent', 'tax_percent', 'content', 'notes'])]
class Document extends Model implements HasMedia
{
    ...
    /**
     * Get the recurring invoice template this document was generated from, if any.
     *
     * @return BelongsTo<RecurringInvoiceTemplate, $this>
     */
    public function recurringInvoiceTemplate(): BelongsTo
    {
    ...
    /**
     * Determine whether this invoice was generated by a recurring invoice template.
     */
    public function isRecurring(): bool
    {
        return $this->recurring_invoice_template_id !== null;
    }
